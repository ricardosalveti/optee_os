...
static const struct processing_id __maybe_unused processing_ids[] = {
	...
	SKS_PROCESSING_ID(SKS_CKM_ECDSA_SHA1),
	SKS_PROCESSING_ID(SKS_CKM_ECDSA_SHA224),
	SKS_PROCESSING_ID(SKS_CKM_ECDSA_SHA256),
	SKS_PROCESSING_ID(SKS_CKM_ECDSA_SHA384),
	SKS_PROCESSING_ID(SKS_CKM_ECDSA_SHA512),
